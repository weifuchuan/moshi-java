...
public class Account extends BaseAccount<Account> {
  ...
  */
  ...
  /*
    ...
    bit:    _ _ _ 1 _ _ _ 0
  */
  public static final int STATUS_WAITER = 1 << 4; // 正常、客服
  ...
  public boolean isWaiter() {
    return BitKit.at(this.getStatus(), 4) == 1;
  }
  ...
  public Account copyModel(){
    return (Account) FstKit.deserialize(FstKit.serialize(this));
  }
}
