...
public final class AuthServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.moshi.im.common.AuthService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.moshi.im.common.AuthReq,
      com.moshi.im.common.AuthReply> getAuthMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Auth",
      requestType = com.moshi.im.common.AuthReq.class,
      responseType = com.moshi.im.common.AuthReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.moshi.im.common.AuthReq,
      com.moshi.im.common.AuthReply> getAuthMethod() {
    io.grpc.MethodDescriptor<com.moshi.im.common.AuthReq, com.moshi.im.common.AuthReply> getAuthMethod;
    if ((getAuthMethod = AuthServiceGrpc.getAuthMethod) == null) {
      synchronized (AuthServiceGrpc.class) {
        if ((getAuthMethod = AuthServiceGrpc.getAuthMethod) == null) {
          AuthServiceGrpc.getAuthMethod = getAuthMethod = 
              io.grpc.MethodDescriptor.<com.moshi.im.common.AuthReq, com.moshi.im.common.AuthReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.moshi.im.common.AuthService", "Auth"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.moshi.im.common.AuthReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.moshi.im.common.AuthReply.getDefaultInstance()))
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void auth(com.moshi.im.common.AuthReq request,
        io.grpc.stub.StreamObserver<com.moshi.im.common.AuthReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.moshi.im.common.AuthReq,
                com.moshi.im.common.AuthReply>(
                  this, METHODID_AUTH)))
          .build();
    }
  }
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public com.moshi.im.common.AuthReply auth(com.moshi.im.common.AuthReq request) {
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.moshi.im.common.AuthReply> auth(
        com.moshi.im.common.AuthReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTH:
          serviceImpl.auth((com.moshi.im.common.AuthReq) request,
              (io.grpc.stub.StreamObserver<com.moshi.im.common.AuthReply>) responseObserver);
          break;
        default:
