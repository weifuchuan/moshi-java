...
import com.moshi.im.server.websocket.common.WsTioUuid;
...
public class WsServerStarter {
  ...
  public WsServerStarter(WsServerConfig wsServerConfig, IWsMsgHandler wsMsgHandler)
    throws IOException {
